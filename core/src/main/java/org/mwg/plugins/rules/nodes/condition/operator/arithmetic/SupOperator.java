...
public class SupOperator extends BinaryOperator {
    public static final String NODE_NAME = "SupOperator";

    public SupOperator(long p_world, long p_time, long p_id, Graph p_graph) {
